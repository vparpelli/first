...
<script type="text/javascript"
  src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDgox6kIiHW75qItOMI1fc7_GJw1i0719c&sensor=false">
</script>
<script type="text/javascript">
var map; //<-- This is now available to both event listeners and the initialize() function
function initialize() {
    var mapOptions = {
        center: new google.maps.LatLng(39.5401759,-107.3247198),
        zoom: 10,
        scrollwheel: false,
        ...
        <div class="main-nav absolute dark-bg">
            <?php 
                if ( has_nav_menu( 'banner-menu' ) ) {
                    ...
                    'echo'            => true,
                    'fallback_cb'     => false,
                    'items_wrap'      => '<ul class="banner-menu map-shadow"> %3$s</ul>',
                    'depth'           => 0 );
