...
<head>
    ...
    <link rel="stylesheet" href="<?php bloginfo('stylesheet_directory'); ?>/js/owl-carousel/owl.carousel.css">
    <link rel="stylesheet" href="<?php bloginfo('stylesheet_directory'); ?>/js/owl-carousel/owl.transitions.css">
    <link rel="stylesheet" href="<?php bloginfo('stylesheet_directory'); ?>/js/owl-carousel/owl.theme.css">
...
<div class="container-fluid home-banner full-width adtl-horizontal-padding relative dark-bg">
    ...
    <div class="banner-title optima absolute" role="navigation">
        Cardiovascular Innovation &<br />Research Institute (CIRI)
    </div>
        <!--<div class="search absolute">
            <input type="text" class="search-box dark-bg pull-right" placeholder="Search" />
        </div>-->
    <div class="main-nav absolute">
        <?php 
...
<div class="mobile-nav container-fluid full-width adtl-horizontal-padding dark-bg">
